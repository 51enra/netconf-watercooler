...
public abstract class WatercoolerServiceAbstractProcessor<I extends DataObject, O extends DataObject> extends
        RpcOutputRequestProcessor {

    private static final Logger LOG = LoggerFactory.getLogger(WatercoolerServiceAbstractProcessor.class);
